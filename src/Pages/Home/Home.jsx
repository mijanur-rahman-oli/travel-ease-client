...
const Home = () => {
    ...
    const categories = [
        { name: "SUVs", icon: "🚙", description: "Spacious & versatile" },
        { name: "Electric", icon: "⚡", description: "Eco-friendly rides" },
        { name: "Vans", icon: "🚐", description: "Perfect for groups" },
        { name: "Sedans", icon: "🚗", description: "Comfort & style" }
    ];
                ...
                <div className="max-w-[1344px] mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
                            ...
                            We connect travelers with reliable car owners, offering a wide range
                            of vehicles to suit every journey.
                        </p>
                        <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                            Whether you're planning a road trip, need a car for business, or
                            looking for an eco-friendly ride, we've got you covered with
                            competitive prices and verified hosts.
                        </p>
                        ...
                        <section className="max-w-[1344px] mx-auto mt-16 px-4">
                <h2 className="text-3xl font-bold text-center mb-8 dark:text-white">Top Categories</h2>
