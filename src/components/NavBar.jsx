          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              <div className="dropdown dropdown-end">
                ...
                >
                  <div className="w-10 rounded-full ring-2 ring-purple-600 ring-offset-base-100 ring-offset-2 hover:ring-pink-600 transition-all">
                    <img
                ...
                <ul
                  tabIndex={0}
                  className="dropdown-content z-[1] menu p-3 shadow-2xl bg-base-100 rounded-2xl w-64 mt-3 border border-base-300"
                >
                  <div className="px-3 py-3 mb-2 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl">
                  ...
                  <li>
                    <NavLink to="/profile" className="flex items-center gap-3 py-2.5 hover:bg-base-200 rounded-xl">
                  ...
                  <li className="mt-2">
                    <button
                      ...
                      className="flex items-center gap-3 py-2.5 text-error hover:bg-error hover:text-white transition-colors rounded-xl font-medium"
                    >
              ...
              <div className="hidden sm:flex gap-2">
                <Link
                  to="/auth/login"
                  className="btn btn-sm btn-ghost hover:bg-base-300 rounded-full font-medium outline-1"
                >
                ...
                <Link
                  to="/auth/register"
                  className="btn btn-sm bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-none rounded-full font-medium shadow-lg hover:shadow-xl transition-all hover:scale-105"
                >
                  Register
                </Link>
              </div>
